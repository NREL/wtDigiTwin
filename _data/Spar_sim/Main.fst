...
"../NREL5MW/NREL5MW_SvD.dat"                                                 ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"HD.dat"                                       HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"                                                 SubFile         - Name of file containing sub-structural input parameters (quoted string)
"../NREL5MW/MAP.dat"     MooringFile     - Name of file containing mooring system input parameters (quoted string)
...
"ES15.6E2"    OutFmt          - Format used for text tabular output, excluding the time channel.  
---------------------- LINEARIZATION -------------------------------------------
